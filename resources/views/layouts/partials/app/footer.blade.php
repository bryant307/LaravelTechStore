<footer class="bg-blue-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
            <div class="mb-1 md:mb-0 grid grid-cols-1">
                ...
                <span class="text-xs text-white justify-end">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-white sm:text-center">© 2025 <a href="https://flowbite.com/"
                    class="hover:underline">Universidad Gerardo Barrios™</a>. Todos los derechos reservados.
            </span>
